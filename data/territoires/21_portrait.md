...
### TERRITOIRE AUX MILLE VISAGES

Bastides Dordogne Périgord, quelques chiffres

- 47 communes
- 18 950 habitants (source INSEE)
- superficie de 66 911 Ha 
...
### TERRITOIRE AUX ELEMENTS IDENTITAIRES FORTS

**Découvrez ses attraits au travers du diaporama**

La rivière Dordogne, les forêts, la topographie variée, autant d’éléments forts composant le paysage. Bastides, châteaux, abbayes et bien d’autres édifices sont à découvrir dans une vallée, sur un promontoire ou un plateau.
...
![Parcelles céréalières et verger de pruniers]({{site.baseurl}}/data/images/21/portrait/21_PORTRAIT_04.jpg)
...
![Ancien séchoir à papier]({{site.baseurl}}/data/images/21/portrait/21_PORTRAIT_14.jpg)
